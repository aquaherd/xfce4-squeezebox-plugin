...
static void squeezebox_write_rc_file(XfcePanelPlugin * plugin,
      SqueezeBoxData * sd)
{
...
EXPORT void on_keyPrev_clicked(gpointer noIdea1, int noIdea2,
      SqueezeBoxData * sd)
{
   squeezebox_prev(sd);
}
...
EXPORT void on_keyStop_clicked(gpointer noIdea1, int noIdea2,
      SqueezeBoxData * sd)
{
}
